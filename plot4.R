...
par(mfrow = c(2,2))
#1
with(data,plot(Global_active_power~xaxis ,type = "l",xlab = ' ', ylab = "Global Active Power"),na.rm = T)
#2
with(data,plot(Voltage~xaxis ,type = "l",xlab = "datetime", ylab = "Voltage"),na.rm = T)
#3
...
#4
with(data,plot(Global_reactive_power~xaxis ,type = "l",xlab = "datetime", ylab = "Global_reactive_power"),na.rm = T)
